        ...
        <div className="flex items-center gap-4 text-neutral-400">
          ...
          {deviceType === 'CNC_PLOTTER' && (
            <div className="flex items-center gap-1.5">
              ...
              <span>Znacznik pasowania CNC</span>
            </div>
          )}
        </div>
