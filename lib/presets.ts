...
export const PRESETS: PresetDef[] = [
  {
    ...
    name: 'Produkcja Gelato (Format papieru 105x148mm A6)',
    badge: 'GELATO POD / 105x148mm',
    description: 'Format papieru 105x148 mm (A6) – zlecenia Gelato (Achim Strob 40 szt. + Annett Eppert 20 szt., nakład 60).',
    payload: {
      name: 'Gelato Produkcja (105x148mm A6)',
      workflow: 'GANGING',
      device_type: 'GUILLOTINE',
      pdf_standard: 'PDF/X-4',
      sheet: {
        name: 'Format papieru 105x148mm (A6)',
        width_mm: 105.0,
        height_mm: 148.0,
        margins_mm: 0.0,
